...
![Spring Petclinic Microservices screenshot](images/app/application-screenshot.png)

**Architecture diagram of the Spring Petclinic Microservices**

![Spring Petclinic Microservices architecture](images/app/microservices-architecture-diagram.jpg)
...
![Screenshot of the chat dialog](images/app/spring-ai.png)
...
![Grafana metrics dashboard](images/app/grafana-custom-metrics-dashboard.png)
