...
Every microservice is a Spring Boot application and can be started locally using IDE(If you see compilation errors install - lombok) or `../mvnw spring-boot:run` command. Please note that supporting services (Config and Discovery Server) must be started before any other application (Customers, Vets, Visits and API).
